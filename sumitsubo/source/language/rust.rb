    ...
    class Language
      ...
      class Rust
        ...
        def comments_in(path, where)
          # Held before it is answered: Spinel loses the type of an Array of
          # objects a method answers straight from a call to one defined further
          # down. matz/spinel#4490.
