...
module Sumitsubo
  module Source
    ...
    #
    # Every reading nested under this writes `class Language` as well. A
    # constant cannot be a class in one file and a module in another: CRuby
    # refuses the second declaration, and a snapshot is regenerated by running
    # the test under it — while the compiler takes the first keyword and drops
    # the second, so nothing here would say otherwise.
    class Language
