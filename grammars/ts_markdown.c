// The Markdown block grammar, linked in rather than loaded: what this
// executable can parse is decided when it is built.
//
...
// cannot, such as where a list item's content is indented to. The runtime
