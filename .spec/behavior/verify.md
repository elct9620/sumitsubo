...
Checking the source against the verifiable part of the specification, and
...
| When | `sumi verify` runs |
| Then | the scenario is answered at the line declaring it, as claimed nowhere it includes |
...
| When | `sumi verify` runs |
| Then | the interface is answered at the line registering it, as claimed nowhere it includes |
