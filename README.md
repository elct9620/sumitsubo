...
```console
$ version=0.1.0-preview11 target=macos-aarch64
...
sumi-0.1.0-preview11-macos-aarch64.tar.gz: OK
...
```console
$ docker run --rm -v "$PWD:/work" ghcr.io/elct9620/sumitsubo:0.1.0-preview11 verify
```
...
```console
$ docker run --rm -u "$(id -u):$(id -g)" -v "$PWD:/work" ghcr.io/elct9620/sumitsubo:0.1.0-preview11 init
```
